...
#define INFOV(...)                                                             \
    minio_ns3::iLogger::__log_func(__FILE__, __LINE__, ILOGGER_VERBOSE,        \
                                   __VA_ARGS__)
#define INFO(...)                                                              \
    minio_ns3::iLogger::__log_func(__FILE__, __LINE__, ILOGGER_INFO,           \
                                   __VA_ARGS__)
#define INFOW(...)                                                             \
    minio_ns3::iLogger::__log_func(__FILE__, __LINE__, ILOGGER_WARNING,        \
                                   __VA_ARGS__)
#define INFOE(...)                                                             \
    minio_ns3::iLogger::__log_func(__FILE__, __LINE__, ILOGGER_ERROR,          \
                                   __VA_ARGS__)
#define INFOF(...)                                                             \
    minio_ns3::iLogger::__log_func(__FILE__, __LINE__, ILOGGER_FATAL,          \
                                   __VA_ARGS__)
